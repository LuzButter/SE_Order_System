...
public class t3_chef 
{
    ...
    public  static void frame2(int tableNum) 
    {
        String food[] = ReadJSONFile.readOrder("Table"+tableNum);
        JFrame ready = new JFrame("訂單");
        ...
        JButton send_out = new JButton("送出");
            ...
            public void actionPerformed(ActionEvent e)
            {
                if(e.getSource() == send_out)
                {
                    ...
                    for(int i = 0; i < food.length; i++)
                    {
                        ...
                        UpdateJSONFile.RemoveAllOrder("Table"+tableNum);
                    }
